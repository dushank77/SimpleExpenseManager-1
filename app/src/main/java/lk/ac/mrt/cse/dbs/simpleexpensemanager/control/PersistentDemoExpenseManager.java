...
public class PersistentDemoExpenseManager extends ExpenseManager {
    ...
    public PersistentDemoExpenseManager(DatabaseHelper dbHelper) {
    ...
    public void setup() {
        ...
        TransactionDAO inMemoryTransactionDAO = new PersistentTransactionDAO(dbHelper);
        setTransactionsDAO(inMemoryTransactionDAO);

        AccountDAO inMemoryAccountDAO = new PersistentAccountDAO(dbHelper);
